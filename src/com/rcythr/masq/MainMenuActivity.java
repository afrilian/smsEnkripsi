				...
				.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						MainMenuActivity.this.startActivity(new Intent(
								MainMenuActivity.this, SMSActivity.class));
					}
				});

		((Button) findViewById(R.id.keyManage))
				.setOnClickListener(new OnClickListener() {
...
/*
		...
		((Button) findViewById(R.id.datapesan))
				.setOnClickListener(new OnClickListener() {

					public void onClick(View v) {
						MainMenuActivity.this.startActivity(new Intent(
								MainMenuActivity.this, Inbox.class));
					}
				});
		...
		((Button) findViewById(R.id.sent))
				.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						MainMenuActivity.this.startActivity(new Intent(
								MainMenuActivity.this, Sent_item.class));
					}
				});
