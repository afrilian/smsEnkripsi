...
public class IntentIntegrator {
   ...
   */
  public AlertDialog initiateScan(int requestCode) {
    return initiateScan(ALL_CODE_TYPES, requestCode);
  }
   ...
   */
  public AlertDialog initiateScan(Collection<String> desiredBarcodeFormats, int requestCode) {
